...
公开市场没有一套同时覆盖所有国家、年份和客户类型的双边支付数据库。本报告使用三种口径。它们回答的问题不同，不能相加，也不能套用同一个市场渗透率。

| 数字口径 | 回答的问题 | 本报告用于哪些走廊 | 主要限制 |
|---|---|---|---|
| 双边个人汇款 | 两个地区之间一年大约汇了多少钱 | 海湾至南亚和菲律宾；欧洲、瑞士至亚洲 | 不包含企业货款、平台商户结算和资本流动 |
| 地区汇款总额 | 一个收款地区或主要汇出国的总体资金池有多大 | 欧洲、海湾至非洲；全球至拉美；美国至全球 | 不能拆出某个发送地区实际贡献多少 |
| 双向货物贸易额 | 企业跨境结算活动大约有多大 | 新加坡、香港至欧洲和海湾 | 不是单向付款额，也不等于支付服务商可处理的金额 |
